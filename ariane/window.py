...
from .app_page import ArianeAppPage
@Gtk.Template(resource_path=f'{rootdir}/ui/window.ui')
class ArianeWindow(Adw.ApplicationWindow):
    __gtype_name__ = 'ArianeWindow'
    ...
    def __init__(self, **kwargs):
        ...
        self.get_application().app_page = ArianeAppPage()
        self.edit.child =self.get_application().app_page
